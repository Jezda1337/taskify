      ...
      <div className="flex min-h-screen bg-no-repeat bg-center bg-cover bg-[url('/images/blob.svg')]">
        <div className="flex w-full ">
          <div className="flex flex-1 justify-center">
            <div className="fade-scale-in max-w-[450px] min-w-[200px] w-full flex flex-col justify-center items-center min-h-screen sm:min-h-0 m-auto px-6 py-12 rounded-md glass-bg">
              {children}
